...
class GymWrapper(Wrapper, gym.Env):
    ...
    def __init__(self, env, keys=None):
        ...
        self.obs_dim = flat_ob["observation"].size
        high = np.inf * np.ones(self.obs_dim)
        low = -high
        self.observation_space = spaces.Dict({
            "observation": spaces.Box(low, high),
            "achieved_goal": spaces.Box(low, high),
            "desired_goal": spaces.Box(low, high)
        })
    ...
    def _flatten_obs(self, obs_dict, verbose=False):
        ...
        return {"observation": np.concatenate(ob_lst).copy(),
                "achieved_goal": np.concatenate(ob_lst).copy(),
                "desired_goal": np.zeros_like(np.concatenate(ob_lst)),
                }
